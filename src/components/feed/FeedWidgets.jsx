        ...
        <div key={w.id} className="bg-white rounded-xl overflow-hidden"
          ...
          {w.imagen_url ? (
            ...
            <div className="w-full flex flex-col items-center justify-center gap-2"
              style={{ aspectRatio: '1/1', background: w.imagen_gradient || 'linear-gradient(135deg,#0B2E68,#1A5AC8)' }}>
          ...
          <div className="p-3">
            ...
            <a href={w.btn_url} target="_blank" rel="noopener noreferrer"
              ...
              style={{ background: w.btn_color || '#FFFFFF', color: w.btn_text_color || '#0047AB' }}>
