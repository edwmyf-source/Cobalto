...
const PERSONAJES = [
  ...
  { id: 7,  min: 960,  emoji: '👩‍🔬', nombre: 'Laboratorista Senior',  desc: 'Sabe cuándo la reacción va mal.',      color: '#5C1A2E', bg: '#FAF7F5' },
    ...
    <div className="flex flex-col gap-3 px-3 py-4 relative">
      ...
      <div className="mt-1">
        <div className="flex items-center justify-between text-[9px] font-bold mb-1" style={{ color: '#1e3a5f' }}>
          <span>INSIGNIA</span>
          <span className="tabular-nums" style={{ color: '#5C1A2E' }}>{Math.min(puntos, 500)} / 500 pts</span>
        </div>
        <div className="relative h-2 rounded-full overflow-hidden" style={{ background: '#dbeafe' }}>
          <div className="h-full rounded-full transition-all duration-500 ease-out relative overflow-hidden"
            style={{
              ...
              background: 'linear-gradient(90deg,#5C1A2E,#2F5233,#8FAE8B,#2F5233)',
...
function PantallaFinal({ stats, onReiniciar }) {
  ...
  return (
    <div className="flex flex-col items-center text-center px-4 py-6 gap-4">
      ...
      <div>
        <p className="text-[10px] font-bold mb-3 tracking-widest" style={{ color: '#2F5233' }}>TU EVOLUCIÓN</p>
      ...
      {showCard && (
        <div className="w-full rounded-2xl overflow-hidden" style={{ background: '#fff', border: '1px solid #E0CFD3' }}>
          ...
          <div className="mx-3 mb-3 rounded-xl p-3" style={{ background: '#f8f9ff', border: '1px solid #E0CFD3' }}>
            <div className="grid grid-cols-5 gap-1">
              {PERSONAJES.map(p => (
                <div key={p.id} className="flex flex-col items-center p-1 rounded-lg transition-all"
                  ...
                  <span className="text-[7px] leading-tight text-center mt-0.5" style={{ color: puntos >= p.min ? p.color : '#8FAE8B' }}>
                    {p.nombre.split(' ')[0]}
                  </span>
                </div>
              ))}
          ...
          <div className="px-3 pb-4">
            <button onClick={onReiniciar} className="w-full py-3 rounded-xl text-white font-black text-sm active:scale-95 transition-all"
              style={{ background: '#5C1A2E', boxShadow: '0 4px 16px rgba(0,26,61,0.35)' }}>
              🔄 Jugar de nuevo
            </button>
          </div>
        </div>
...
export default function QuimicaGamePage() {
  ...
  return (
    <div className="max-w-lg mx-auto" style={{ paddingBottom: 100 }}>
      <div className="rounded-2xl overflow-hidden shadow-sm mx-3 mt-3" style={{ background: '#ffffff', border: '1px solid #E0CFD3' }}>
